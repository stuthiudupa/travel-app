...
class Footer extends React.Component {
    render() {
        ...
        <div id="endofpage"><br/><br/></div>

        <div className="row test">
          <div className="col-md-4">
          <h1 className="logo me-auto"><a href="/">MAHARASHTRA<span>.</span></a></h1>
          <br/>
          <ul id="links1" className="nav nav-footer">
          ...
          <div className="col-md-4">
          <h3>RELATED SITES</h3>
          <ul id="links2" className="nav nav-footer">
                <li className="active"><a href="https://www.incredibleindia.org/content/incredibleindia/en/destinations/states/maharashtra.html">incredible india</a></li>
                <li><a href="https://www.maharashtratourism.gov.in/">maharashtra tourism</a></li>
                <li><a href="https://www.maharashtratourism.gov.in/">make my trip</a></li>
              </ul>
                <br/>
                <br/>
            <h3>TOURIST HOTLINE</h3>
            <div id="hotline">
            <p><span className="glyphicon glyphicon-map-marker"></span> 156/157, 15th Floor, Nariman Bhavan,<br/> Nariman Point, Mumbai - 400021.</p>
          ...
          <div id="subscribe" className="col-md-4">

          <h3>CONNECT WITH US</h3>
          <ul id="socmed" className="nav navbar-nav">
                <li className="active"><Link to="/"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                width="50" height="50"
                viewBox="0 0 32 32">
